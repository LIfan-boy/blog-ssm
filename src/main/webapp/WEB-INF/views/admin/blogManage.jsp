...
<script type="text/javascript">
	...
	function openBlogModifyTab() {
		...
		window.parent.openTab("修改博客","blog/openModifyBlog?id=" + row.id, "icon-writeblog");
	}
...
<table id="dg" title="博客管理" class="easyui-datagrid" fitColumns="true" pagination="true"
	url="${blog}/admin/blog/listBlog" toolbar="#tb">
	<thead>
		<tr>
			...
			<th field="clickHit" width="200" align="center">评论次数</th>
			<th field="replyHit" width="200" align="center">回复次数</th>
