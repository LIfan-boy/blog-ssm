...
<script type="text/javascript" charset="utf-8"
	src="${blog}/static/ueditor1_4_3_3/ueditor.all.min.js"></script>
		...
		<form id="myform" method="post">
			<table cellspacing="20px">
				<tr>
					...
					<td><input type="text" id="title" name="title" value="${blogs.title }"
				...
				<tr>
					...
					<td><input type="text" id="keyWord" name="keyWord"
						style="width: 400px" value="${blogs.keyWord }"/>&nbsp;&nbsp;&nbsp;多个关键字的话请用空格隔开</td>
				</tr>
				<tr>
					<td></td>
					<td><a href="javascript:submitData()"
						class="easyui-linkbutton" data-options="iconCls:'icon-submit'">提交修改</a>
					</td>
				</tr>
			</table>
		</form>
